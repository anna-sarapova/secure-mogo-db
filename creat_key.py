...
with MongoClient("mongodb+srv://mongo-user:QqldBkX2zzPLoNOL@cluster0.5io68.mongodb.net/Cluster0?retryWrites=true&w=majority", auto_encryption_opts=csfle_opts) as client:
